export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://www.moneytool.in/og-images/tds-calculator.png",
        width: 1200,
        height: 630,
        alt: "TDS Calculator for India",
      },
    ],
  },
  twitter: {
    ...
    title: "Free TDS Calculator — Calculate Tax Deducted at Source",
    description: "Calculate TDS on various income sources instantly.",
    image: "https://www.moneytool.in/og-images/tds-calculator.png",
  },
  alternates: {
    canonical: "https://www.moneytool.in/tds-calculator",
  },
};
