...
const BLOG_POSTS = [
  {
    ...
    excerpt: "Compare the financial advantages of buying a home with a loan versus renting. Understand EMI, tax benefits, and long-term wealth creation.",
    date: "2026-05-15",
    category: "Loans",
  ...
  },
  {
    ...
    excerpt: "Understand the differences between Systematic Investment Plans (SIP) and Fixed Deposits (FD). Learn which suits your financial goals.",
    date: "2026-05-10",
  ...
  },
  {
    ...
    excerpt: "Learn how EMI is calculated, factors affecting it, and how to reduce your EMI burden with smart financial planning.",
    date: "2026-05-05",
    category: "Loans",
  ...
  },
  {
    ...
    excerpt: "Discover effective tax-saving investments and strategies to reduce your income tax liability under Section 80C, 80D, and more.",
    date: "2026-04-28",
    category: "Taxes",
  ...
  },
  {
    ...
    excerpt: "Everything you need to know about Public Provident Fund - eligibility, interest rates, tax benefits, and how to maximize returns.",
    date: "2026-04-20",
    category: "Investments",
  ...
  },
  {
    ...
    excerpt: "Understand GST filing, calculation, compliance requirements, and how to use the GST calculator to avoid errors.",
    date: "2026-04-12",
    category: "Business",
...
export default function Blog() {
  return (
    <main style={{ maxWidth: "1100px", margin: "0 auto", padding: "60px 24px", color: "#f4f4f5" }}>
      <div style={{ marginBottom: "60px" }}>
        <h1 style={{ fontSize: "36px", fontWeight: "800", marginBottom: "16px", color: "#f4f4f5" }}>
          Financial Blog
        </h1>
        <p style={{ fontSize: "16px", color: "#a1a1aa", marginBottom: "24px", lineHeight: "1.6" }}>
          Expert guides and articles on financial planning, investments, loans, taxes, and personal finance for Indians.
        </p>
      </div>
        ...
        {BLOG_POSTS.map((post) => (
          ...
          >
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "start", marginBottom: "12px" }}>
              <span style={{ fontSize: "12px", background: "rgba(16,185,129,0.1)", color: "#10b981", padding: "4px 8px", borderRadius: "4px", fontWeight: "500" }}>
                {post.category}
              </span>
            ...
            <h2 style={{ fontSize: "18px", fontWeight: "600", marginBottom: "12px", color: "#f4f4f5", lineHeight: "1.4" }}>
              {post.title}
            </h2>
            <p style={{ fontSize: "14px", color: "#a1a1aa", marginBottom: "16px", lineHeight: "1.6" }}>
              {post.excerpt}
            </p>
            <Link href={`/blog/${post.slug}`} style={{ fontSize: "14px", color: "#10b981", fontWeight: "600", textDecoration: "none" }}>
              Read More →
            </Link>
          </article>
        ))}
      ...
      <div style={{ marginTop: "60px", padding: "40px 24px", background: "#111113", borderRadius: "12px", border: "1px solid #27272a", textAlign: "center" }}>
        <h2 style={{ fontSize: "20px", fontWeight: "600", marginBottom: "12px", color: "#f4f4f5" }}>
        ...
        <div style={{ display: "flex", gap: "8px", justifyContent: "center", flexWrap: "wrap" }}>
          <input
            ...
            style={{ padding: "10px 16px", background: "#0a0a0a", border: "1px solid #27272a", borderRadius: "8px", color: "#f4f4f5", fontSize: "14px", width: "100%", maxWidth: "300px" }}
          />
          <button style={{ padding: "10px 24px", background: "#10b981", color: "#fff", border: "none", borderRadius: "8px", fontSize: "14px", fontWeight: "600", cursor: "pointer" }}>
            Subscribe
          </button>
        </div>
      </div>
