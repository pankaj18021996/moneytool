...
function HomeLoanCalculatorClient() {
  const [amount, setAmount] = React.useState(3000000);
  ...
  return (
    <div style={{ background: "#111113", border: "1px solid #27272a", borderRadius: 16, padding: 24, marginBottom: 16 }}>
      <div style={{ marginBottom: 24 }}>
        ...
        <input type="range" min="500000" max="100000000" step="100000" value={amount} onChange={e => setAmount(Number(e.target.value))} style={{ width: "100%", accentColor: "#10b981" }} />
      </div>
