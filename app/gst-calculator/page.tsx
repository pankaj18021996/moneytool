          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <div style={{ background: "#111113", border: "1px solid #27272a", borderRadius: 16, padding: 20 }}>
              ...
              {gstSlabs.map((slab) => (
                <div key={slab.rate} style={{
                  ...
                  <p style={{ fontSize: 13, fontWeight: 600, color: "#f4f4f5" }}>{slab.desc}</p>
                  <p style={{ fontSize: 13, color: "#10b981", fontWeight: 600 }}>{slab.rate}</p>
                </div>
              ))}
            </div>
            ...
            <div style={{ background: "#111113", border: "1px solid #27272a", borderRadius: 16, padding: 20 }}>
              ...
              <div style={{ fontSize: 12, color: "#71717a", lineHeight: 2 }}>
                <p><span style={{ color: "#10b981" }}>Price</span> = Base amount</p>
                <p><span style={{ color: "#10b981" }}>Rate</span> = 5, 12, 18, or 28%</p>
                <p><span style={{ color: "#10b981" }}>Total</span> = Price + GST</p>
              </div>
            </div>
